...
label defenseless:
    scene defeat
    "Conradia has been raided, and everyone in it was slaughtered."
    return
...
label childSoldier:
    ...
    k "King Con, I have some great news! The child soldiers have been trained!
    These are some of the most well trained soldiers I have ever seen!"
    show king con happy at left
    c "That is great news!"
    k "I do have some bad news however."
    c "What is it this time?"
    k "your farmers have gone on strike becuase you haven't paid them since
    last year."
    show king con sad at left
    c "Those greedy farmers!"
    k "I suggest that we should downgrade our palace a bit in order to pay the farmers.
    We could also send the child soldiers to arrest all of the farmers who refuse to
    work."

    menu:

        "Downgrade your palace to pay farmers":
             jump pay

        "Send child soldiers to arrest non-cooperative farmers":
            jump arrest


label pay:
    scene badpalace
    show king con sad at right
    show knight at left
    c "Am I seriously expected to live here? This is a peasants house!"
    k "Sorry Sir. This is the only place we could find that fits our new
    budget. I guess you'll just have to make do"
    c "Well it's better than nothing."
    k "Yes it is Sir. You have made a great sacrifice for your nation, and
    I am sure everyone here appreciates it."
    k "You have made all the right decisions for this nation, and as a result,
    Conradia is more prosperous than it has ever been"
    show king con happy at right
    c "You are right! Thanks for all of your hard work and guidance."
    return

label arrest:
    scene farm
    show king con normal at right
    show knight at left
    k "Sir, your child soldiers have arrested all of the farmers. Now we have no
    food."
    show king con sad at right
    c "who could've possibly seen this coming?"
    hide king con sad
    hide knight
    scene defeat
    "Everyone in Conradia starved to death."
    return
...
label meeting:
    ...
    c "Where is Sir Hicklebottom? We were supposed to meet here over an hour ago."
    k "I have no clue Sir."
    c "I'm starting to get an awful feeling about this."
    k "Look over there, there's a whole army. I thought we were supposed to come alone?"
    hide king con normal
    show king con sad at left
    "It's a trap! that sneaky b..."
    hide king con sad
    hide night

    scene defeat
    "You were immediately killed by an archer, and your knight was taken hostage"
    return
